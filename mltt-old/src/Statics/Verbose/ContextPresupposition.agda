...
presup-ctx-tm (Ǔ-wf H) = H
presup-ctx-tm (Ť-wf H) = presup-ctx-tm H
...
presup-ctx-≡ty (Ǔ-T H) = H
presup-ctx-≡ty (Ť-T H) = presup-ctx-tm H
...
presup-ctx-≡tm (Ǔ-cong H) = H
presup-ctx-≡tm (Ť-cong H) = presup-ctx-≡tm H
...
presup-ctx-≡tm (Π̌-Ť H₀ H₁) = presup-ctx-tm H₀
presup-ctx-≡tm (ℕ̌-Ť H) = H
presup-ctx-≡tm (Ǔ-Ť H) = H
presup-ctx-≡tm (Ť-Ť H) = presup-ctx-tm H
...
presup-ctx-≡tm (Ǔ-[] H) = presup-ctx-subst H .fst
presup-ctx-≡tm (Ť-[] H₀ H₁) = presup-ctx-subst H₁ .fst
