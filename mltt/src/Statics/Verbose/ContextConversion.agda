...
conv-ty Γ≡Γ′ (El-wf H₀) = El-wf (conv-tm Γ≡Γ′ H₀)
...
conv-≡ty Γ≡Γ′ (El-cong H₀) = El-cong (conv-≡tm Γ≡Γ′ H₀)
conv-≡ty Γ≡Γ′ ([]-cong H₀ H₁) = []-cong H₀ (conv-≡subst Γ≡Γ′ H₁)
conv-≡ty Γ≡Γ′ (Π̌-El H₀ H₁) = Π̌-El (conv-tm Γ≡Γ′ H₀) (conv-tm (,ctx-cong′ Γ≡Γ′ (El-wf H₀) (El-wf (conv-tm Γ≡Γ′ H₀))) H₁)
conv-≡ty Γ≡Γ′ (ℕ̌-El P₀) = ℕ̌-El (presup-≡ctx Γ≡Γ′ .snd)
conv-≡ty Γ≡Γ′ (Π̇-[] H₀ H₁ H₂) = Π̇-[] H₀ H₁ (conv-subst Γ≡Γ′ H₂)
conv-≡ty Γ≡Γ′ (ℕ̇-[] H₀) = ℕ̇-[] (conv-subst Γ≡Γ′ H₀)
conv-≡ty Γ≡Γ′ (U̇-[] H₀) = U̇-[] (conv-subst Γ≡Γ′ H₀)
conv-≡ty Γ≡Γ′ (El-[] H₀ H₁) = El-[] H₀ (conv-subst Γ≡Γ′ H₁)
...
conv-tm Γ≡Γ′ (Π̌-wf H₀ H₁) = Π̌-wf (conv-tm Γ≡Γ′ H₀) (conv-tm (,ctx-cong′ Γ≡Γ′ (El-wf H₀) (El-wf (conv-tm Γ≡Γ′ H₀))) H₁)
...
conv-≡tm Γ≡Γ′ (Π̌-cong P₀ H₀ H₁) = Π̌-cong (conv-tm Γ≡Γ′ P₀) (conv-≡tm Γ≡Γ′ H₀) (conv-≡tm (,ctx-cong′ Γ≡Γ′ (El-wf P₀) (El-wf (conv-tm Γ≡Γ′ P₀))) H₁)
