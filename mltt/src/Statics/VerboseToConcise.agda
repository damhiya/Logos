...
V⇒C-ty (V.El-wf M-wf) = C.El-wf (V⇒C-tm M-wf)
...
V⇒C-≡ty (V.El-cong M-eq) = C.El-cong (V⇒C-≡tm M-eq)
V⇒C-≡ty (V.[]-cong A-eq σ-eq) = C.[]-cong (V⇒C-≡ty A-eq) (V⇒C-≡subst σ-eq)
V⇒C-≡ty (V.Π̌-El _ N-wf) = C.Π̌-El (V⇒C-tm N-wf)
V⇒C-≡ty (V.ℕ̌-El Γ-wf) = C.ℕ̌-El (V⇒C-ctx Γ-wf)
...
V⇒C-≡ty (V.El-[] M-wf σ-wf) = C.El-[] (V⇒C-tm M-wf) (V⇒C-subst σ-wf)
