...
V⇒C-≡ty (V.Ǔ-T Γ-wf) = C.Ǔ-T (V⇒C-ctx Γ-wf)
V⇒C-≡ty (V.Ť-T M-wf) = C.Ť-T (V⇒C-tm M-wf)
...
V⇒C-tm (V.Ǔ-wf Γ-wf) = C.Ǔ-wf (V⇒C-ctx Γ-wf)
V⇒C-tm (V.Ť-wf M-wf) = C.Ť-wf (V⇒C-tm M-wf)
...
V⇒C-≡tm (V.Ǔ-cong Γ-wf) = C.Ǔ-cong (V⇒C-ctx Γ-wf)
V⇒C-≡tm (V.Ť-cong M-eq) = C.Ť-cong (V⇒C-≡tm M-eq)
...
V⇒C-≡tm (V.Π̌-Ť M-wf N-wf) = C.Π̌-Ť (V⇒C-tm N-wf)
V⇒C-≡tm (V.ℕ̌-Ť Γ-wf) = C.ℕ̌-Ť (V⇒C-ctx Γ-wf)
V⇒C-≡tm (V.Ǔ-Ť Γ-wf) = C.Ǔ-Ť (V⇒C-ctx Γ-wf)
V⇒C-≡tm (V.Ť-Ť M-wf) = C.Ť-Ť (V⇒C-tm M-wf)
...
V⇒C-≡tm (V.Ǔ-[] σ-wf) = C.Ǔ-[] (V⇒C-subst σ-wf)
V⇒C-≡tm (V.Ť-[] M-wf σ-wf) = C.Ť-[] (V⇒C-tm M-wf) (V⇒C-subst σ-wf)
